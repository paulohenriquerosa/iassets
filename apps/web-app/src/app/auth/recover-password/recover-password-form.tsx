    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-12 border p-8 rounded">
        <div className="text-center space-y-1 font-medium">
          <h2 className="text-base text-foreground">Código de recuperação</h2>
          <p className="text-xs text-muted-foreground font-light">Insira o código de recuperação recebido no seu e-mail.</p>
        </div>
